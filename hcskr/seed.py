...
SS0 = [696885672, 92635524, 382128852, 331600848, 340021332, 487395612, 747413676, 621093156, 491606364, 54739776,
...
class SEED:
    ...
    def SeedEncrypt(self, Src, RoundKey):
        ...
        if L_ENDIAN == 1:
            return struct.pack('>LLLL', endianchange(R0[0]), endianchange(R1[0]), endianchange(L0[0]),
                               endianchange(L1[0]))
        else:
